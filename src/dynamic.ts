...
export class DynamicProperties<Value extends number | string | boolean | Object> {
     ...
     * @returns {Value[]} - The entries of the dynamic property
     */
    public map(callback: (value: [string, Value], index: number, array: [string, Value][]) => Value, thisArg?: any): Value[] {
